...
public class DebitCard implements Account {
    ...
    private final Account bonusAccount;

    public DebitCard(long id, TransactionManager transactionManager) {
        this.id = id;
        this.transactionManager = transactionManager;
        this.entries = new Entries();
        this.bonusAccount = new BonusAccount(0.01);
    }

    public DebitCard(long id, TransactionManager transactionManager, Account bonusAccount) {
        this.id = id;
        this.transactionManager = transactionManager;
        this.entries = new Entries();
    ...
    public boolean withdraw(double amount, Account beneficiary) {
        ...
        if (amount > 0 && currentBalance - amount >= 0) {
            ...
            Entry entry = new Entry(this, transaction, amount, LocalDateTime.now());
